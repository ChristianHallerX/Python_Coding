...
def getSum(a: int, b: int) -> int:
    ...
    mask = 0xFFFFFFFF  # python workaround: hex of 32bit mask, since python uses arbitrarily large binaries
    ...
    while b != 0:
        ...
        b = (
            (tmp_a & b) << 1
        ) & mask  # carry: & = AND binary operation, then bitshift 1 <<, mask = python workaround

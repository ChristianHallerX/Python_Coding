"""
1438. Longest Continuous Subarray With Absolute Diff Less Than or Equal to Limit (Medium, actually Hard?)
...
def longestSubarray(nums: list[int], limit: int) -> int:
    ...
    By maintaining two deques, one for the maximum values and one for the minimum values within the current window,
    we can dynamically adjust the window size while ensuring the condition is met.
